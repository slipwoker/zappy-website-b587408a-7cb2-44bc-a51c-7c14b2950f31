document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    ...
    const validateField = (input) => {
      ...
      if (value && (name.includes('phone') || type === 'tel')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b587408a-7cb2-44bc-a51c-7c14b2950f31',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b587408a-7cb2-44bc-a51c-7c14b2950f31';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b587408a-7cb2-44bc-a51c-7c14b2950f31';
